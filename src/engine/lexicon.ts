...
const FUNCTIONS: Draft[] = [
  E({ id: "ne", term: "Ne", category: "Function",
    ...
    inSystem: "Extraverted observer. Pairs with an intraverted decider (Ti or Fi) to form an Absorb-primary signature. Its attitude-flip is Ni; its axis opposite is Si.",
    seeAlso: ["ni", "si", "observer", "gather"] }),
  E({ id: "ni", term: "Ni", category: "Function",
    short: "Intraverted Intuition — convergence on the single line a situation is already running down.",
    definition:
    ...
    inSystem: "Intraverted observer. Pairs with an extraverted decider (Te or Fe) to form a Broadcast-primary signature.",
  ...
  E({ id: "si", term: "Si", category: "Function",
    short: "Intraverted Sensing — continuity, precedent, and the body's own record.",
    definition:
    ...
    inSystem: "Intraverted observer. As a Cave it produces the Gate of Obligation in ENTP and ENFP.",
  ...
  E({ id: "te", term: "Te", category: "Function",
    ...
    inSystem: "Extraverted decider. Pairs with an intraverted observer (Ni or Si) to form a Broadcast-primary signature.",
    seeAlso: ["ti", "fi", "decider", "tribe"] }),
  E({ id: "ti", term: "Ti", category: "Function",
    short: "Intraverted Thinking — a private framework that must remain free of contradiction.",
    definition:
    ...
    inSystem: "Intraverted decider. Pairs with an extraverted observer (Ne or Se) to form an Absorb-primary signature.",
  ...
  E({ id: "fi", term: "Fi", category: "Function",
    short: "Intraverted Feeling — a private register of worth that does not require agreement.",
    definition:
    ...
    inSystem: "Intraverted decider. As a Cave it produces the Gate of the Self in ENTJ and ESTJ.",
...
const ANIMALS: Draft[] = [
  ...
  E({ id: "blast", term: "Broadcast", category: "Animal",
    short: "Intraverted observing + extraverted deciding. Directive, convergent, outcome-driven.",
    definition:
  ...
  E({ id: "consume", term: "Absorb", category: "Animal",
    short: "Extraverted observing + intraverted deciding. Interactive, exploratory, low-stakes.",
    definition:
  ...
  E({ id: "sleep", term: "Settle", category: "Animal",
    short: "Both functions intraverted. Withdrawal into private processing.",
    definition:
...
const COIN_POLES: [string, string, string, string][] = [
  ...
  ["identity", "Identity", "The anchor decider is intraverted — Ti or Fi.",
  ...
  ["organize", "Organize", "The anchor observer is intraverted — Ni or Si.",
  ...
  ["responding", "Responding", "Waits to be approached, and finishes a thought before moving.",
   "Waits to be approached and finishes a thought before moving to the next one. Responding types are not slower thinkers; they complete more of the thinking before any of it becomes audible, which initiating types routinely misread as having nothing to contribute. Maps to intraversion."],
